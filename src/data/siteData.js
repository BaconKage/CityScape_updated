export const brand = {
  name: 'Cityscape Consulting',
  subtitle: 'Mandate-focused real estate consulting for premium developments.',
  description:
    'Cityscape Consulting combines strategy, branding, and execution discipline to accelerate sales for high-trust, high-value real estate mandates.',
}
...
export const processSteps = [
  {
    ...
    details:
      'Audit mandate goals, portfolio context, audience, competitive landscape, and commercial aspirations.',
  },
  {
    title: 'Market Positioning',
    details:
      'Create category-defining messaging and premium visual identity that removes market noise.',
  },
  {
    title: 'Branding & Campaign Planning',
    details:
      'Launch architecture across digital, creative, and partner-led channels with a focused narrative calendar.',
  },
  {
    title: 'Lead Generation',
    details:
      'Use lead scoring, qualification controls, and funnel handoff playbooks to preserve lead quality.',
  },
  {
    title: 'Channel Activation',
    details:
      'Synchronize partners, brokers, and team playbooks for scale without dilution.',
  },
  {
    title: 'Sales Closure Support',
    details:
      'Sales scripting, negotiation coaching, and weekly conversion reviews until handover milestones.',
  },
]
...
export const testimonials = [
  {
    quote:
      'Cityscape gave our project a premium identity and gave our sales team a clear playbook. Lead quality and closure speed improved noticeably in the first quarter.',
    name: 'Arjun Mehta',
    role: 'Senior Director, UrbanBuild Homes',
  },
  {
    quote:
      'They treated us like a strategic partner, not a service vendor. From brand framing to partner activation, everything felt sharp and execution-ready.',
    name: 'Neha Kulkarni',
    role: 'VP, Meridian Developers',
  },
  {
    quote:
      'The team understands what premium buyers care about: clarity, trust, and consistency. Our campaign to close cycle is stronger than before.',
    name: 'Sanjay Nair',
    role: 'Head of Sales, Crestline Realty',
  },
]
...
export const socialLinks = [
  ...
  {
    platform: 'Instagram',
    url: 'https://www.instagram.com/cityscapeconsulting.in/',
    icon: 'Instagram',
  },
  {
    platform: 'LinkedIn',
    url: 'https://www.linkedin.com/company/103331236/admin/dashboard/',
    icon: 'Linkedin',
  },
  {
    platform: 'YouTube',
